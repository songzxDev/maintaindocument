...
public class MaintainDocumentCost {
	private Long costId;
	...
	private List<MaintainDocumentCost> costChildren = new ArrayList<MaintainDocumentCost>();
	...
	public List<MaintainDocumentCost> getCostChildren() {
		return costChildren;
	}

	public void setCostChildren(List<MaintainDocumentCost> costChildren) {
