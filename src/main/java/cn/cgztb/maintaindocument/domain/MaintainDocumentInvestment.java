...
public class MaintainDocumentInvestment {
	...
	private String zhuanyexianzongjingli1;

	private String zhuanyexianzongjingli1LoginId;

	private String zhuanyexianzongjingli2;

	private String zhuanyexianzongjingli2LoginId;
	...
	private List<MaintainDocumentInvestment> investmentChildren = new ArrayList<MaintainDocumentInvestment>();
	...
	public String getZhuanyexianzongjingli1() {
		return zhuanyexianzongjingli1;
	}

	public void setZhuanyexianzongjingli1(String zhuanyexianzongjingli1) {
		this.zhuanyexianzongjingli1 = zhuanyexianzongjingli1 == null ? null : zhuanyexianzongjingli1.trim();
	}

	public String getZhuanyexianzongjingli1LoginId() {
		return zhuanyexianzongjingli1LoginId;
	}

	public void setZhuanyexianzongjingli1LoginId(String zhuanyexianzongjingli1LoginId) {
		this.zhuanyexianzongjingli1LoginId = zhuanyexianzongjingli1LoginId == null ? null : zhuanyexianzongjingli1LoginId.trim();
	}

	public String getZhuanyexianzongjingli2() {
		return zhuanyexianzongjingli2;
	}

	public void setZhuanyexianzongjingli2(String zhuanyexianzongjingli2) {
		this.zhuanyexianzongjingli2 = zhuanyexianzongjingli2 == null ? null : zhuanyexianzongjingli2.trim();
	}

	public String getZhuanyexianzongjingli2LoginId() {
		return zhuanyexianzongjingli2LoginId;
	}

	public void setZhuanyexianzongjingli2LoginId(String zhuanyexianzongjingli2LoginId) {
		this.zhuanyexianzongjingli2LoginId = zhuanyexianzongjingli2LoginId == null ? null : zhuanyexianzongjingli2LoginId.trim();
	}
	...
	public List<MaintainDocumentInvestment> getInvestmentChildren() {
		return investmentChildren;
	}

	public void setInvestmentChildren(List<MaintainDocumentInvestment> investmentChildren) {
		this.investmentChildren = investmentChildren;
	}
